...
source $HOME/.config/nvim/plug-config/py-mode.vim
"source $HOME/.config/nvim/plug-config/jedi-vim.vim
"source $HOME/.config/nvim/plug-config/syntastic.vim
"source $HOME/.config/nvim/plug-config/psuquyomi.vim
"source $HOME/.config/nvim/plug-config/typescript-vim.vim
